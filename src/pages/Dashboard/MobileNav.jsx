    ...
    <div className="fixed bottom-0 left-0 right-0 w-full border-t-2 bg-white">
      <div className="flex items-center justify-center">
        <button
          ...
          <span
            className={`w-16 sm:w-20 rounded-br-lg rounded-bl-lg h-2 bg-primary absolute top-0 ${
              nav != "home" && "hidden"
            }`}></span>
          <div
            ...
            <p className="text-[12px] sm:text-Overline-LG font-light">خانه</p>
          </div>
        </button>
        <button
          ...
          <div
            ...
            <p className="text-[12px] sm:text-Overline-LG font-light">سبدخرید ها</p>
          </div>
        </button>
        <button
          className="mx-5 flex flex-col items-center justify-center relative"
          ...
          <div
            ...
            <p className="text-[12px] sm:text-Overline-LG font-light">محصولات</p>
          </div>
        </button>
        <button
          className="mx-5  flex flex-col items-center justify-center relative"
          ...
          <div
            ...
            <p className="text-[12px] sm:text-Overline-LG font-light">پروفایل</p>
          </div>
        </button>
      </div>
    </div>
