  ...
  return (
    <>
      ...
      <div>
        ...
        <h4 className="text-Body-MD text-black">---</h4>
      </div>
      <hr />
      <div className="w-full flex flex-col justify-around my-4 gap-y-4">
        ...
        <span>
          ...
          <h4 className="text-Body-MD text-black">Instagram.com/{userInfo.instagramId}</h4>
        </span>
        <span>
      ...
      <Link to="editProfile" className="bg-black px-24 py-4 mx-auto text-white rounded-lg text-Button-SM">ویرایش پروفایل</Link>
      </div>
    </>
  );
};
